...
newTextFirst = document.createTextNode('wasmiddel');
newItemFirst.appendChild(newTextFirst);
list.insertBefore(newItemFirst, list.firstChild);

newItemFirst = document.createElement('li');
newTextFirst = document.createTextNode('bier');
newItemFirst.appendChild(newTextFirst);
list.insertBefore(newItemFirst, list.firstChild);
...
for (i = 0; i < listItems.length; i++) {
    ...
    newItemFirst.className = 'hell';
    newItemLast.className = 'heaven';
}

let heading = document.querySelector('h2');
let headingText = heading.firstChild.nodeValue;
let totalItems = listItems.length;
let newHeading = headingText + '<span>' + totalItems
+ '</span>';
